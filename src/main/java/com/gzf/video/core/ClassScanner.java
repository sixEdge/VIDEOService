...
public abstract class ClassScanner {
    ...
    private void scan0(final File dir, final String packagePath) throws Exception {
        ...
        for (File f : fs) {
            ...
            String sourcePath = getSourceClassName(f.getAbsolutePath(), packagePath);
    ...
    private static String getSourceClassName(final String absolutePath, final String basePackagePath) {
        return absolutePath
